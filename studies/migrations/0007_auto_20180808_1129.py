...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='study',
            name='briefing',
            field=models.FileField(blank=True, upload_to='', validators=[main.validators.validate_pdf_or_doc], verbose_name='Upload hier de informatiebrief (in .pdf of .doc(x)-formaat)'),
        ),
        migrations.AlterField(
            model_name='study',
            name='deception',
        ...
        migrations.AlterField(
            ...
            field=models.FileField(blank=True, help_text='If it is already signed, upload the signed declaration form. If it is not signed yet, you can upload the unsigned document and send the document when it is signed to the secretary of the EtCL', upload_to='', validators=[main.validators.validate_pdf_or_doc], verbose_name='Upload hier de toestemmingsverklaring van de schoolleider/hoofd van het departement (in .pdf of .doc(x)-format)'),
        ),
        migrations.AlterField(
            model_name='study',
            name='director_consent_information',
            field=models.FileField(blank=True, upload_to='', validators=[main.validators.validate_pdf_or_doc], verbose_name='Upload hier de informatiebrief voor de schoolleider/hoofd van het departement (in .pdf of .doc(x)-formaat)'),
        ),
        migrations.AlterField(
            model_name='study',
            name='informed_consent',
            field=models.FileField(blank=True, upload_to='', validators=[main.validators.validate_pdf_or_doc], verbose_name='Upload hier de toestemmingsverklaring (in .pdf of .doc(x)-formaat)'),
        ),
        migrations.AlterField(
            model_name='study',
            name='necessity',
        ...
        migrations.AlterField(
            ...
            field=models.FileField(blank=True, upload_to='', validators=[main.validators.validate_pdf_or_doc], verbose_name='Upload hier de informatiebrief voor de ouders (in .pdf of .doc(x)-formaat)'),
        ),
        migrations.AlterField(
            model_name='study',
            name='risk',
