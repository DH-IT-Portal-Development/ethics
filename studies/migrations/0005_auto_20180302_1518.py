...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.FileField(blank=True, upload_to=b'', verbose_name=b'Please upload the the information letter for the school director/head of the department (in .pdf of .doc(x)-formaat)', validators=[core.validators.validate_pdf_or_doc]),
        ),
        migrations.AddField(
            model_name='study',
            name='parents_information',
            field=models.FileField(blank=True, upload_to=b'', verbose_name=b'Please upload the information letter for the parents here (in .pdf of .doc(x)-formaat)', validators=[core.validators.validate_pdf_or_doc]),
        ),
    ]
