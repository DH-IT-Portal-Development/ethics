...
proposal_urls = [
    ...
    path(
        ...
        include(
            [
                path(
                    "public/",
                    ProposalsPublicArchiveView.as_view(),
                    name="public_archive",
                ),
                path("export/", ProposalsExportView.as_view(), name="archive_export"),
                path(
                    "export/<int:pk>/",
                    ProposalsExportView.as_view(),
                    name="archive_export",
                ),
                path(
                    "archive_status/<int:pk>/",
                    ChangeArchiveStatusView.as_view(),
                    name="archive_status",
                ),
                ...
                path(
                    "<str:committee>/",
                    ProposalUsersOnlyArchiveView.as_view(),
                    name="archive",
                ),
            ]
        ),
    ...
    path(
        ...
        include(
            [
                ...
                path("pre/", ProposalCreatePreAssessment.as_view(), name="create_pre"),
                path(
                    "practice/<int:reason>/",
                    ProposalCreatePractice.as_view(),
                    name="create_practice",
                ),
                path(
                    "pre_approved/",
                    ProposalCreatePreApproved.as_view(),
    ...
    path(
        ...
        include(
            [
                ...
                path(
                    "practice/", ProposalStartPractice.as_view(), name="start_practice"
                ),
                path(
                    "pre_approved/",
                    ProposalStartPreApproved.as_view(),
    ...
    path(
        "update_data_management/<int:pk>/",
        ProposalUpdateDataManagement.as_view(),
        name="update_data_management",
    ),
    path(
        "update_date_start/<int:pk>/",
        ProposalUpdateDateStart.as_view(),
    ...
    path(
        ...
        include(
            [
                ...
                path("pre/", ProposalSubmitPreAssessment.as_view(), name="submit_pre"),
                path(
                    "pre_approved/",
                    ProposalSubmitPreApproved.as_view(),
    ...
    path(
        ...
        include(
            [
                ...
                path(
                    "pre/",
                    ProposalSubmittedPreAssessment.as_view(),
                    name="submitted_pre",
                ),
                path(
                    "pre_approved/",
                    ProposalSubmittedPreApproved.as_view(),
    ...
    path(
        ...
        include(
            [
                ...
                path("revision/", ProposalCopyRevision.as_view(), name="copy_revision"),
                path(
                    "amendment/", ProposalCopyAmendment.as_view(), name="copy_amendment"
                ),
            ]
        ),
    ),
    ...
    path(
        "wmo/application/<int:pk>/",
        include(
            [
                path("", WmoApplication.as_view(), name="wmo_application"),
                path(
                    "pre/",
                    WmoApplicationPreAssessment.as_view(),
                    name="wmo_application_pre",
                ),
            ]
        ),
    ),
