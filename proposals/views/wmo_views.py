...
def check_wmo(request):
    ...
    if doubt:
        ...
        message = _('Neem contact op met <a href="{link}">{secretary}</a> om de twijfels weg te nemen.').format(link='mailto:'+ secretary.email , secretary=secretary.get_full_name())
