...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.FileField(blank=True, upload_to='', validators=[core.validators.validate_pdf_or_doc], verbose_name='Upload hier uw aanvraag (in .pdf of .doc(x)-formaat)'),
        ),
        migrations.AlterField(
            model_name='wmo',
        ...
        migrations.AlterField(
            ...
            field=models.FileField(blank=True, upload_to='', validators=[core.validators.validate_pdf_or_doc], verbose_name='Upload hier de beslissing van het METC (in .pdf of .doc(x)-formaat)'),
        ),
    ]
