...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('proposals', '0011_auto_20160510_1058'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.BooleanField(default=False, verbose_name='Uw studie moet beoordeeld worden door de METC, maar dient nog wel bij de ETCL te worden geregistreerd. Is deze studie al aangemeld bij een METC?'),
        ),
    ]
