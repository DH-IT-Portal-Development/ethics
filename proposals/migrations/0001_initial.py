    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('informed_consent_pdf', models.FileField(blank=True, upload_to=b'', verbose_name='Upload hier de toestemmingsverklaring (in PDF-formaat)', validators=[proposals.models.validate_pdf])),
                ('briefing_pdf', models.FileField(blank=True, upload_to=b'', verbose_name='Upload hier de informatiebrief (in PDF-formaat)', validators=[proposals.models.validate_pdf])),
