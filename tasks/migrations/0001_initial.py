        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "registration",
                    models.ForeignKey(
                        to="tasks.Registration", on_delete=models.CASCADE
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.NullBooleanField(
                        verbose_name="Vindt het afnemen van de taak plaats onder het toeziend oog van de leraar of een ander persoon die bevoegd is?"
                    ),
                ),
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        null=True,
                        verbose_name="De totale geschatte netto taakduur van uw sessie komt op basis van uw opgave per taak uit op <strong>%d minuten</strong>. Hoe lang duurt <em>de totale sessie</em>, inclusief ontvangst, instructies per taak, pauzes tussen taken, en debriefing? (bij labbezoek dus van binnenkomst tot vertrek)",
                    ),
                ),
                (
                    "setting",
                ...
                (
                    "study",
                    models.ForeignKey(to="studies.Study", on_delete=models.CASCADE),
                ),
            ],
            options={
                "ordering": ["order"],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=200, verbose_name="Wat is de naam van de taak?"
                    ),
                ),
                (
                    "description",
                    models.TextField(
                        verbose_name="Beschrijf de taak die de deelnemer moet uitvoeren, en leg kort uit hoe deze taak (en de eventuele manipulaties daarbinnen) aan de beantwoording van uw onderzoeksvragen bijdraagt."
                    ),
                ),
                (
                    "duration",
                ...
                (
                    "feedback",
                    models.NullBooleanField(
                        verbose_name="Krijgt de deelnemer tijdens of na deze taak feedback op zijn/haar gedrag of toestand?"
                    ),
                ),
                (
                    "feedback_details",
                    models.TextField(
                        verbose_name="Beschrijf hoe de feedback wordt gegeven.",
                        blank=True,
                    ),
                ),
                (
                ...
                (
                    "session",
                    models.ForeignKey(to="tasks.Session", on_delete=models.CASCADE),
                ),
            ],
            options={
                "ordering": ["order"],
