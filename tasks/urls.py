...
from .views.session_views import SessionUpdate, SessionEnd, SessionDelete, SessionCreate, SessionStart, SessionOverview
...
urlpatterns = [
    ...
    path("session/overview/<int:pk>/", SessionOverview.as_view(), name="session_overview"),
    # Task(s)
